...
<body>
<header style="font-size:30px; height:40px; position: fixed; width: 100%; top: 0; background-color: red; color: yellow; text-align: center; line-height: 40px;left :0">  헤더 </header>
